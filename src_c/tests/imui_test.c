...
static bool check_button(void) {
    ...
    ok = expect(!sound_imui_button_rect_id(&imui, "play", "play", first),
        "button hovered frame fired") &&
    ...
    begin_frame(&imui, &recording, &input);
    ok = expect(sound_imui_button_rect_id(&imui, "play", "play", first),
        "button release inside did not fire") &&
        ok;
    sound_imui_end(&imui);
    ...
    begin_frame(&imui, &recording, &input);
    (void)sound_imui_button_rect_id(&imui, "play", "play", first);
    sound_imui_end(&imui);
    ...
    (void)sound_imui_button_rect_id(&imui, "play", "play", first);
    (void)sound_imui_button_rect_id(&imui, "stop", "stop", second);
...
static bool check_null_input_draw_only(void) {
    ...
    bool button_fired =
        sound_imui_button_rect_id(&imui, "draw-only", "draw-only", rect);
    sound_imui_end(&imui);
...
static bool check_text_scale(void) {
    ...
    begin_frame(&imui, &recording, &input);
    (void)sound_imui_button_rect_id(&imui, "scale", "scale", rect);
    sound_imui_end(&imui);
...
static bool check_id_stack(void) {
    ...
    (void)sound_imui_button_rect_id(&imui, "same", "same", left_rect);
    sound_imui_pop_id(&imui);
    sound_imui_push_id(&imui, "right");
    uint32_t right_id = sound_imui_id(&imui, "same");
    (void)sound_imui_button_rect_id(&imui, "same", "same", right_rect);
    sound_imui_pop_id(&imui);
    sound_imui_end(&imui);
