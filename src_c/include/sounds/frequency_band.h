...
#define SOUND_FREQUENCY_LOW_MAX_HZ 200.0
#define SOUND_FREQUENCY_MID_MIN_HZ 100.0
#define SOUND_FREQUENCY_MID_MAX_HZ 2400.0
#define SOUND_FREQUENCY_HIGH_MIN_HZ 2000.0
